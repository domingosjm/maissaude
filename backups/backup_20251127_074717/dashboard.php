...
<body class="bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 dark:from-gray-900 dark:via-gray-800 dark:to-slate-900 min-h-screen transition-colors duration-300">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <!-- 2. Recepção -->
            <a href="recepcao.php" class="module-card glass-effect rounded-2xl shadow-xl border-2 border-emerald-200 dark:border-gray-700 overflow-hidden group animate-slide-up" style="animation-delay: 0.1s;">
            ...
            <!-- 3. Consultas -->
            <a href="medico_dashboard.php" class="module-card glass-effect rounded-2xl shadow-xl border-2 border-emerald-200 dark:border-gray-700 overflow-hidden group animate-slide-up" style="animation-delay: 0.15s;">
                <div class="p-8 text-center">
                    <div class="mb-6 inline-block">
            ...
            <!-- 6. Laboratório -->
            <a href="laboratorio.php" class="module-card glass-effect rounded-2xl shadow-xl border-2 border-emerald-200 dark:border-gray-700 overflow-hidden group animate-slide-up" style="animation-delay: 0.3s;">
                <div class="p-8 text-center">
                    <div class="mb-6 inline-block">
            ...
            <!-- 7. Farmácia -->
            <a href="farmacia.php" class="module-card glass-effect rounded-2xl shadow-xl border-2 border-emerald-200 dark:border-gray-700 overflow-hidden group animate-slide-up" style="animation-delay: 0.35s;">
                <div class="p-8 text-center">
                    <div class="mb-6 inline-block">
  ...
  <!-- 8. Psiquiatria -->
            ...
            <!-- 9. Financeiro -->
            <a href="financeiro.php" class="module-card glass-effect rounded-2xl shadow-xl border-2 border-emerald-200 dark:border-gray-700 overflow-hidden group animate-slide-up" style="animation-delay: 0.45s;">
                <div class="p-8 text-center">
                    <div class="mb-6 inline-block">
